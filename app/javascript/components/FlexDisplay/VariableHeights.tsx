    ...
    <div id='variable-heights'>
      ...
      <div className='container'>
        ...
        <div className='item2'>
          ...
          original form, accompanied by English versions from the 1914 translation by H. Rackham. It
          ...
          years, sometimes by accident, sometimes on purpose (injected humour and the like). There
