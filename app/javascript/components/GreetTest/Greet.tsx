  ...
  return (
    <div id='Greet'>
      ...
      <div>
        ...
        <ol>
          # For list items, name attribute or text does not work # To select a specific list item, we have to provide # an aria-label
          attribute and assign it that value
      ...
      <div>
        ...
        <input type='range' min='1' max='100' value='50' id='slider-element' onChange={() => logger.info('Hi')} />
      </div>
      <div>
      ...
      <section>
        ...
        <input type='textbox' placeholder='firstName' onChange={() => logger.info('Hello')} disabled />
        <input type='textbox' value='ValueInput' onChange={() => logger.info('Hello')} />
